<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
      ...
      <div class="flex justify-between h-16">
          <div class="flex">
              ...
              <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                  ...
                  <!-- Посилання "Користувачі" показується лише адміністратору -->
          ...
          <div class="hidden sm:flex sm:items-center sm:ms-6">
              <!-- Teams Dropdown (якщо активовано Jetstream Teams) -->
  ...
  <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
      <div class="pt-2 pb-3 space-y-1">
          ...
          <!-- Responsive: Користувачі (тільки адміністратору) -->
          @if(Auth::user()->isAdmin())
      ...
      <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
          ...
          <div class="mt-3 space-y-1">
              <!-- Responsive: Управління аккаунтом -->
              ...
              <!-- Responsive: Team Management (якщо активовано) -->
              @if (Laravel\Jetstream\Jetstream::hasTeamFeatures())
                  <div class="border-t border-gray-200 dark:border-gray-600"></div>
                  <div class="block px-4 py-2 text-xs text-gray-400">
                      {{ __('Manage Team') }}
