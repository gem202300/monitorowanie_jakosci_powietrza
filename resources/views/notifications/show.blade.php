<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('notifications.index') }}" class="border border-gray-400 text-gray-700 dark:border-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 px-4 py-2 rounded transition">
                ← Wróć do listy
            </a>
        </div>
    </x-slot>
    ...
    <div class="py-6 max-w-7xl mx-auto">
        ...
        <div class="bg-white p-6 rounded shadow mb-6">
            ...
            <div class="border-b border-gray-200 pb-4 mb-6">
                <h3 class="text-2xl font-semibold text-gray-900 mb-2">{{ $notification->data['title'] ?? 'Powiadomienie' }}</h3>
                <p class="text-sm text-gray-600">Utworzono: <span class="font-medium">{{ \Carbon\Carbon::parse($notification->created_at)->format('d.m.Y o H:i') }}</span></p>
            </div>

            <!-- Treść powiadomienia -->
            <div class="mb-6">
                <h4 class="text-sm font-semibold text-gray-700 uppercase tracking-wide mb-2">Treść</h4>
                <div class="bg-gray-50 border border-gray-200 rounded p-4 text-gray-800 leading-relaxed whitespace-pre-wrap">
            ...
            <div class="border-t border-gray-200 pt-6">
                ...
                <div class="mt-4">
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded p-4 text-gray-800 text-sm leading-relaxed whitespace-pre-wrap">
        ...
        <div class="flex gap-2">
            <form action="{{ route('notifications.destroy', $notification->id) }}" method="POST" class="inline" onsubmit="return confirm('Czy na pewno chcesz usunąć to powiadomienie?');">
                @csrf
                @method('DELETE')
